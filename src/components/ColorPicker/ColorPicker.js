...
const ColorPicker = ({title, selectedColor, onColorSelected}) => <div className="color-options">
...
const ColorOption = ({color, isSelected, onClick}) => <button onClick={() => onClick(color)} className="color-option">
