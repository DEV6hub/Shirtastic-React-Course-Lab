...
const Shipping = (props) => {
  ...
  let postalZipProps = {};
  const regionsForSelectedCountry = regions[country];
  ...
  return (
    <div>
      <h2>Awesome!</h2>
      <p>{contactIntro}</p>
      <FormWithConstraints onSubmit={shippingInfoSubmit} noValidate ref={shippingForm}>
        <Row className="row-item">
          <Col className="form-group">
            ...
            <FieldFeedbacks for="name">
              <FieldFeedback when="valueMissing">You must provide name.</FieldFeedback>
        ...
        <div>
          <Link to="/catalog">
            <button type="button" className="primary-btn float-left">
              DO THIS LATER
            </button>
          </Link>
